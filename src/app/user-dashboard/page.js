...
const UserDashboard = () => {
  ...
  // Dynamically set the class for rankBadge based on rank
  const rankBadgeClass = {
    Bronze: styles.bronze,
    Silver: styles.silver,
    Gold: styles.gold,
    Platinum: styles.platinum,
  }[rank] || styles.bronze; // Default to bronze if rank is not found
      ...
      <div className={styles.card}>
        ...
        <div className={styles.userInfo}>
          ...
          <div className={styles.rank}>
            <span className={`${styles.rankBadge} ${rankBadgeClass}`}>{rank}</span>
          </div>
        </div>
